...
- Updated dependencies
  - @agentionai/marshall-engine@0.25.0
...
- 1dc49c1: Fix the status row still overflowing when the ctrl-e hint or a queued-prompt count was showing.
...
- f8623f3: Fix status and tool-call rows overflowing on a narrow terminal.
...
- Updated dependencies [e771ee1]
  - @agentionai/marshall-plugin-browser@0.3.0
...
- Updated dependencies
  ...
  - @agentionai/marshall-engine@0.24.0
  - @agentionai/marshall-plugin-browser@0.2.0

## 0.23.2

### Patch Changes

- 81d7345: Run the rendering process with `NODE_ENV=production`, fixing a memory leak in long sessions.
...
- Updated dependencies [81d7345]
  ...
  - @agentionai/marshall-engine@0.23.0
...
- 7f710c9: Fix reasoning rendering as a column of single words when a provider breaks its deltas at every
  token.
...
- Updated dependencies [7f710c9]
  - @agentionai/marshall-engine@0.20.2
...
- 263651b: Bound how much committed reasoning the transcript retains, so an all-day
...
- Updated dependencies [19114de]
  - @agentionai/marshall-engine@0.16.2
